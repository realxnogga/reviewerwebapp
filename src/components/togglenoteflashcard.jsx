...
export const ToggleNoteFlashcard = () => {
    ...
    return (
        <aside onMouseLeave={() => {dispatch(clearIsToggleNoteFlashCardOpenState())}} className={`${themeHolder.colorbg2} ${isToggleNoteFlashCardOpen ? 'w-[8rem]' : ''} absolute top-0 right-0 bg-gray-800 h-full w-0 overflow-hidden z-10`}>
