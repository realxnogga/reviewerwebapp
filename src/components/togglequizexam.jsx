            ...
            <ul className={`${themeHolder.colortxt1} h-[90%] text-nowrap flex flex-col overflow-scroll noScrollbar`}>
                ...
                <li>
                    ...
                    <ul className={`${isShowDrop.FoundationofEducationDropdown ? `h-fit ${themeHolder.colorbg3}` : 'h-0'} overflow-hidden cursor-pointer`}>
                        <li className={`hover:${themeHolder.colorbg1} py-2 px-8`}>Exam 1 in FE</li>
                        <li className={`hover:${themeHolder.colorbg1} py-2 px-8`}>Quiz 1 in FE </li>
                    </ul>
                    {/* ------------------------------------------------------------------------ */}
                    <li
                    ...
                    <ul className={`${isShowDrop.PrinciplesofTeachingDropdown ? `h-fit ${themeHolder.colorbg3}` : 'h-0'} overflow-hidden cursor-pointer`}>
                        <li className={`hover:${themeHolder.colorbg1} py-2 px-8`}>Exam 1 in PT </li>
                        <li className={`hover:${themeHolder.colorbg1} py-2 px-8`}>Quiz 1 in PT </li>
                    </ul>
                    {/* ------------------------------------------------------------------------ */}
                    <li
                    ...
                    <ul className={`${isShowDrop.ChildandAdolescentDevelopmentDropdown ? `h-fit ${themeHolder.colorbg3}` : 'h-0'} overflow-hidden cursor-pointer`}>
                        <li className={`hover:${themeHolder.colorbg1} py-2 px-8`}>Exam 1 in CAD </li>
                        <li className={`hover:${themeHolder.colorbg1} py-2 px-8`}>Quiz 1 in CAD </li>
                    </ul>
                    {/* ------------------------------------------------------------------------ */}
                    <li
                    ...
                    <ul className={`${isShowDrop.FacilitatingLearningDropdown ? `h-fit ${themeHolder.colorbg3}` : 'h-0'} overflow-hidden cursor-pointer`}>
                        <li className={`hover:${themeHolder.colorbg1} py-2 px-8`}>Exam 1 in FL </li>
                        <li className={`hover:${themeHolder.colorbg1} py-2 px-8`}>Quiz 1 in FL </li>
                    </ul>
                    {/* ------------------------------------------------------------------------ */}
                    <li
                    ...
                    <ul className={`${isShowDrop.AssessmentofStudentLearningDropdown ? `h-fit ${themeHolder.colorbg3}` : 'h-0'} overflow-hidden cursor-pointer`}>
                        <li className={`hover:${themeHolder.colorbg1} py-2 px-8`}>Exam 1 in ASL </li>
                        <li className={`hover:${themeHolder.colorbg1} py-2 px-8`}>Quiz 1 in ASL </li>
                    </ul>
                    {/* ------------------------------------------------------------------------ */}
                    <li
                    ...
                    <ul className={`${isShowDrop.DevelopmentallyAppropriatePracticesinTeachingDropdown ? `h-fit ${themeHolder.colorbg3}` : 'h-0'} overflow-hidden cursor-pointer`}>
                        <li className={`hover:${themeHolder.colorbg1} py-2 px-8`}>Exam 1 in DAPT </li>
                        <li className={`hover:${themeHolder.colorbg1} py-2 px-8`}>Quiz 1 in DAPT </li>
                    </ul>
                    {/* ------------------------------------------------------------------------ */}
                    <li
                    ...
                    <ul className={`${isShowDrop.CurriculumDevelopmentDropdown ? `h-fit ${themeHolder.colorbg3}` : 'h-0'} overflow-hidden cursor-pointer`}>
                        <li className={`hover:${themeHolder.colorbg1} py-2 px-8`}>Exam 1 in CD</li>
                        <li className={`hover:${themeHolder.colorbg1} py-2 px-8`}>Quiz 1 in CD </li>
                    </ul>
                    {/* ------------------------------------------------------------------------ */}
                    <li
                    ...
                    <ul className={`${isShowDrop.FieldStudyandPracticeDropdown ? `h-fit ${themeHolder.colorbg3}` : 'h-0'} overflow-hidden cursor-pointer`}>
                        <li className={`hover:${themeHolder.colorbg1} py-2 px-8`}>Exam 1 in FSP</li>
                        <li className={`hover:${themeHolder.colorbg1} py-2 px-8`}>Quiz 1 in FSP </li>
                    </ul>
